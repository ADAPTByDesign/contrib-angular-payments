angular.module('angularPayments', []);angular.module('angularPayments')
    ...
    .factory('_Format', [
        'Cards', 'Common', '$filter', function(Cards, Common, $filter) {
...
angular.module('angularPayments')
    .directive('paymentsFormat', [
    '$window', '_Format', function($window, _Format) {
        return {
            restrict: 'A',
            require: 'ngModel',
    ...
    .factory('_Validate', [
        'Cards', 'Common', '$parse', function(Cards, Common, $parse) {
    ...
    .directive('paymentsValidate', [
        '$window', '_Validate', '_ValidateWatch', function($window, _Validate, _ValidateWatch) {
            return {
                restrict: 'A',
                require: 'ngModel',
                link: function(scope, elem, attr, ctrl) {
...
;angular.module('angularPayments')
    .directive('stripeForm', [
        '$window', '$parse', 'Common', function($window, $parse, Common) {
